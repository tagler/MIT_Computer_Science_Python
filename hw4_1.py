...
def isValidWord(word, hand, wordList):
    ...
    if word not in wordList:
        ...
        # determine if letters in word are in hard
        for letter in word:
            # see if letter is in hand
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                print('"' + str(user_input) + '" earned ' + str(points) + ' points. Total: ' + str(user_score) + ' points')
                # Update the hand
                hand = updateHand(hand, user_input)

    # Game is over (user entered a '.' or ran out of letters), so tell user the total score
    print('Total score: ' + str(user_score) + ' points.')
...
def playGame(wordList):
    ...
    user_hand = {}
    while True:
        user_select = raw_input('Enter n to deal a new hand, r to replay the last hand, or e to end game: ')
        if user_select == 'n':
